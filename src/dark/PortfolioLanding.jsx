              ...
              <div className="row row--35 align-items-center">
                <div className="col-lg-5">
                  <div className="thumbnail">
                    <LazyLoadImage
                      ...
                      alt="About Images"
                      effect="blur"
                      placeholderSrc="/assets/images/about/me.png"
                    />
                  </div>
                </div>
                <div className="col-lg-7">
                  ...
                  <a
                    ...
                    target="_blank"
                    href="https://docs.google.com/document/d/1blVxGmzL1L7aVeKlEwUhxfS29XfnSn8p/edit?usp=sharing&ouid=114820040043608163609&rtpof=true&sd=true"
                  >
                    <span>My CV</span>
                  </a>
                </div>
        ...
        <div className="portfolio-area ptb--120 bg_color--1">
          <div className="portfolio-sacousel-inner">
            <div className="container">
              <div className="row">
                <div className="col-lg-12">
                  <div className="section-title text-center service-style--3 mb--30 mb_sm--0">
                    ...
                    <p>A display of my projects and skillset:</p>
                  </div>
                </div>
              </div>
              <div className="row">
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="view-more-btn mt--60 mt_sm--30 text-center"></div>
                </div>
              </div>
            </div>
          </div>
