...
const SocialShare = [
    {Social: <FaGithub /> , link: 'https://github.com/Jukes312'},
    {Social: <FaLinkedinIn /> , link: 'https://www.linkedin.com/in/jograj-singh-0b6042185'},
]
class HeaderThree extends Component{
    ...
    render(){
        ...
        if(logo === 'light'){
            ...
            logoUrl = <img src="/assets/images/logo/logoo.png" alt="Digital Agency" />;
